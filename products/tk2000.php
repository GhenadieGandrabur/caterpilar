...
<div class="container">
    <h2 class="text-center">TK-2000M</h2>
    <a href="../uhf.php"> <img src="../includes/img/arrow.png" ></a>
    ...
    Raportul pret-calitate o face foarte atractiva.</h5>
            ...
            <table class="table table-striped">        
                ...
                <tr>
                    <td><h5>Aceasta statie este foarte solicitata de constructori. 
    Raportul pret-calitate o face foarte atractiva.</h5></td>
                </tr>
                </tbody>
            </table>
        </div>
